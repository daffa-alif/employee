...
use App\Http\Controllers\{AuthController,BerkasEmployeeController,NilaiController,UserController, KonfirmasiController,BerkasNilaiController};
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/berkas-nilai', [BerkasNilaiController::class, 'index'])->middleware('auth')->name('berkasnilai.index');
...
Route::middleware(['auth', 'SuperAdmin'])->group(function () {
    Route::post('/konfirmasi/{nilai}/accept', [KonfirmasiController::class, 'accept'])->name('konfirmasi.accept');
    Route::post('/konfirmasi/{nilai}/reject', [KonfirmasiController::class, 'reject'])->name('konfirmasi.reject');
