...
<body class="bg-gray-100">
    <div class="flex h-screen">
        <!-- Sidebar Oval Nav -->
        <aside class="fixed left-6 top-1/2 transform -translate-y-1/2 bg-blue-900 text-white p-6 w-56 h-80 rounded-3xl shadow-xl flex flex-col space-y-6 items-center">
            <h2 class="text-lg font-bold">Admin Menu</h2>
            <a href="{{ route('users.index') }}" class="flex items-center space-x-2 p-3 w-full rounded-lg bg-blue-700 hover:bg-blue-600 text-center justify-center">
                <i class="fas fa-users"></i> <span>Manajemen User</span>
            </a>
            <a href="{{ route('nilais.index') }}" class="flex items-center space-x-2 p-3 w-full rounded-lg bg-blue-700 hover:bg-blue-600 text-center justify-center">
