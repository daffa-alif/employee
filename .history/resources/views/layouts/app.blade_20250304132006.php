        ...
        <body class="bg-gray-100">
            <div class="container mx-auto p-4">
                ...
                <nav class="bg-white shadow-md p-4 flex justify-between">
                    <h1 class="text-xl font-bold">Akun Karyawan</h1>
                    <div>
                        <button onclick="showSection('nilai')" class="px-4 py-2 bg-blue-500 text-white rounded-lg">Nilai</button>
                        <button onclick="showSection('berkas')" class="px-4 py-2 bg-green-500 text-white rounded-lg">Berkas</button>
                    </div>
                </nav>
        
                <!-- Content Sections -->
                <div id="nilai" class="mt-4 p-4 bg-white shadow-md rounded-lg">
                    <h2 class="text-lg font-semibold">Nilai Karyawan</h2>
                    <p>Data nilai karyawan ditampilkan di sini.</p>
                </div>
                
                <div id="berkas" class="mt-4 p-4 bg-white shadow-md rounded-lg hidden">
                    <h2 class="text-lg font-semibold">Berkas Karyawan</h2>
                    <p>Data berkas karyawan ditampilkan di sini.</p>
                </div>
            </div>
        
            <script>
                function showSection(section) {
                    document.getElementById('nilai').classList.add('hidden');
                    document.getElementById('berkas').classList.add('hidden');
